...
\renewcommand{\taskgroup}{Vyresniųjų} % grupė: jaunesniųjų/vyresniųjų
...
\example%
{\includefile{task.s01.in}}%
{\includefile{task.s01.out}}%
{
...
\Grading
% Informacija apie vertinimą, jeigu tokios yra.
Už testus, kuriuose $n \le 10\ 000$, galima surinkti iki 50\% balų.

\Constraints
% Pakartokite apribojimus įvesčiai, n < ... etc.
